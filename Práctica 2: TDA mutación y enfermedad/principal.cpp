////////////////////////////////////////////////////////////////////////////////
// TDA enfermedad y TDA mutación
// Integrantes del grupo y porcentaje de trabajo:
...
int cuentaMutacionesEnfermedad(vector<mutacion> &  vm, const string & s) {
  ...
  for (int i = 0; i < vm.size(); ++i){    //recorrer vector de mutaciones vm
    ...
    for(int k = 0; k < vm[i].getEnfermedades().size(); ++k)
    	enfermedades.push_back(vm[i].getEnfermedades().at(k)); 
